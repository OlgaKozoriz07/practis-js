...
? Cтворіть масив styles з елементами «Джаз» та «Блюз».
...
// const index = styles.indexOf('Bluez');
...
? та об'єднати їх у новий масив, після чого вивести 
? у консоль лог повідомлення "Масив елементів, що містять підстроку substring: ..." 
...
//     }
//   }
//   return `Масив елементів, що містить підстроку ${sub}: ${newArray.join(', ')}`;
// }
// console.log(findSubString(wordsArray, substring));

/*
? Порахуй кількість слів у рядку, використовуючи методи масивів 
? і створи новий рядок, роділений дефісами у нижньому регістрі.
*/

// const message = 'JavaScript is a popular programming language.';
// console.log('message: ', message);

// const splitMessage = message.split(' '); // розбиваємо рядок на масив слів
// console.log('splitMessage: ', splitMessage);

// const messageLength = splitMessage.length; //рахуємо к-сть слів у масиві сплітмеседж
// console.log('messageLength: ', messageLength);

// const newMessage = message.toLowerCase().replaceAll(' ', '-'); //форматуємо рядок в нижній регістер і замінюємо пробіли на дефіси
...
/*
? Створи 2 масиви чисел. Обєднай їх за допомогою методу масиву. 
? Створи нові масив і за допомогою циклу for або for..of, 
? в перший масив збери усі парні числи, 
? а в другій усі не парні і виведи їх в консоль.
*/
